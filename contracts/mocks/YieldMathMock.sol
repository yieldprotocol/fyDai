...
contract YieldMathMock {
    ...
    function chaiOutForYDaiIn (
        ...
        uint128 timeTillMaturity, int128 k, int128 c, int128 g)
    external pure returns (uint128) {
        return YieldMath.yDaiOutForChaiIn(chaiReserves, yDAIReserves, yDAIAmount, timeTillMaturity, k, c, g);
    }
    ...
    function chaiOutForYDaiIn64 (
        ...
        uint128 timeTillMaturity, int128 k, int128 c, int128 g)
    external pure returns (uint128) {
        return YieldMath64.yDaiOutForChaiIn(chaiReserves, yDAIReserves, yDAIAmount, timeTillMaturity, k, c, g);
    }
    ...
    function chaiOutForYDaiIn48 (
        ...
        uint128 timeTillMaturity, int128 k, int128 c, int128 g)
    external pure returns (uint128) {
        return YieldMath48.yDaiOutForChaiIn(chaiReserves, yDAIReserves, yDAIAmount, timeTillMaturity, k, c, g);
    }
