...
migrations = await Migrations.at("0x06782C68bECc13c2d08abe54A6Cb1C5fb019Bbe0")
...
fyDai0 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai20Oct5")))
fyDai1 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai20Oct6")))
fyDai2 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai20Oct9")))
fyDai3 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai20Oct31")))
fyDai4 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai20Dec31")))
fyDai5 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai21Mar31")))
fyDai6 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai21Jun30")))
fyDai7 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai21Sep30")))
fyDai8 = await FYDai.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDai21Dec31")))
...
pool0 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP20Oct5")))
pool1 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP20Oct6")))
pool2 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP20Oct9")))
pool3 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP20Oct31")))
pool4 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP20Dec31")))
pool5 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP21Mar31")))
pool6 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP21Jun30")))
pool7 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP21Sep30")))
pool8 = await Pool.at(await migrations.contracts(ethers.utils.formatBytes32String("fyDaiLP21Dec31")))
...
await dai.approve(pool6.address, MAX)
await dai.approve(pool7.address, MAX)
await dai.approve(pool8.address, MAX)
...
await fyDai6.approve(treasury.address, MAX)
await fyDai7.approve(treasury.address, MAX)
await fyDai8.approve(treasury.address, MAX)
...
await fyDai5.approve(pool4.address, MAX)
await fyDai6.approve(pool4.address, MAX)
await fyDai7.approve(pool4.address, MAX)
await fyDai8.approve(pool4.address, MAX)
...
await pool5.addDelegate(yieldProxy.address)
await pool6.addDelegate(yieldProxy.address)
await pool7.addDelegate(yieldProxy.address)
await pool8.addDelegate(yieldProxy.address)

// Obtain Weth    
await weth.deposit({ value: "680" + WAD })

// Obtain Dai
await wethJoin.join(me, "680" + WAD)
await vat.frob(ETH_A, me, me, me, "680" + WAD, "200000" + WAD)
await daiJoin.exit(me, "200000" + WAD)
...
await pool0.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
await pool1.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
await pool2.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
await pool3.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
await pool4.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
await pool5.mint(me, me, "1" + WAD, { gasPrice: 100000000000})
...
// Add liquidity
await yieldProxy.addLiquidity(pool0.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool1.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool2.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool3.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool4.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool5.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool6.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool7.address, "30000" + WAD, MAX)
await yieldProxy.addLiquidity(pool8.address, "30000" + WAD, MAX)
