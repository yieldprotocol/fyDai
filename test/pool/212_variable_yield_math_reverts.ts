...
contract('VariableYieldMath - Base', async (accounts) => {
  ...
  describe('fyDaiOutForVYDaiIn reverts', () => {
    ...
    it("Too far from maturity", async () => {
      await expectRevert(
        yieldMath.fyDaiOutForVYDaiIn(OneToken.mul(TEN), OneToken.mul(TEN), OneToken, secondsInFourYears.add(new BN(60*60)), k, g0, ONE64),
    ...
    it("Exchange rate overflow", async () => {
      await expectRevert(
        yieldMath.fyDaiOutForVYDaiIn(MAX.div(TWO).add(OneToken), OneToken.mul(TEN), OneToken, secondsInOneYear, k, g0, ONE64.mul(TWO)),
  ...
  describe('vyDaiOutForFYDaiIn reverts', () => {
    ...
    it("Too far from maturity", async () => {
      await expectRevert(
        yieldMath.vyDaiOutForFYDaiIn(OneToken.mul(TEN), OneToken.mul(TEN), OneToken, secondsInFourYears.add(new BN(60*60)), k, g0, ONE64),
        'YieldMath: Too far from maturity'
      )
    })
    ...
    it("Exchange rate overflow", async () => {
      await expectRevert(
        yieldMath.vyDaiOutForFYDaiIn(MAX.div(TWO).add(OneToken), OneToken.mul(TEN), OneToken, secondsInOneYear, k, g0, ONE64.mul(TWO)),
        'YieldMath: Exchange rate overflow'
      )
    })
  ...
  describe('fyDaiInForVYDaiOut reverts', () => {
    ...
    it("Too far from maturity", async () => {
      await expectRevert(
        yieldMath.fyDaiInForVYDaiOut(OneToken.mul(TEN), OneToken.mul(TEN), OneToken, secondsInFourYears.add(new BN(60*60)), k, g0, ONE64),
        'YieldMath: Too far from maturity'
      )
    })
    ...
    it("Exchange rate overflow", async () => {
      await expectRevert(
        yieldMath.fyDaiInForVYDaiOut(MAX.div(TWO).add(OneToken), OneToken.mul(TEN), OneToken, secondsInOneYear, k, g0, ONE64.mul(TWO)),
        'YieldMath: Exchange rate overflow'
      )
    })
  ...
  describe('vyDaiInForFYDaiOut reverts', () => {
    ...
    it("Too far from maturity", async () => {
      await expectRevert(
        yieldMath.vyDaiInForFYDaiOut(OneToken.mul(TEN), OneToken.mul(TEN), OneToken, secondsInFourYears.add(new BN(60*60)), k, g0, ONE64),
        'YieldMath: Too far from maturity'
      )
    })
    ...
    it("Exchange rate overflow", async () => {
      await expectRevert(
        yieldMath.vyDaiInForFYDaiOut(MAX.div(TWO).add(OneToken), OneToken.mul(TEN), OneToken, secondsInOneYear, k, g0, ONE64.mul(TWO)),
        'YieldMath: Exchange rate overflow'
      )
    })
