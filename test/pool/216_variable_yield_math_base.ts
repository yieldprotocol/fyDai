...
contract('VariableYieldMath - Base', async (accounts) => {
  ...
  describe('Test trading functions', async () => {
    ...
    it('Test `fyDaiOutForVYDaiIn` function', async () => {
      var values = [
      ...
      for (var i = 0; i < values.length; i++) {
        ...
        var result
        try {
          result = await yieldMath.fyDaiOutForVYDaiIn(daiReserves, fyDaiReserves, daiAmount, timeTillMaturity, k, g, ONE)
        } catch (e) {
          result = [false, undefined]
        }
    ...
    it('Test `vyDaiOutForFYDaiIn` function', async () => {
      var values = [
        ['0x0', '0x0', '0x0', '0x0', '0x0', '0x0', true],
        ['0x0', '0x0', '0x0', '0x1', '0xFFFFFFFFFFFFFFFF', '0x10000000000000000', true, 0.0],
        ['0x0', '0x0', '0x0', '0x1', '0x10000000000000000', '0x10000000000000000', false],
      ...
      for (var i = 0; i < values.length; i++) {
        ...
        var result
        try {
          result = await yieldMath.vyDaiOutForFYDaiIn(daiReserves, fyDaiReserves, fyDaiAmount, timeTillMaturity, k, g, ONE)
        } catch (e) {
          result = [false, undefined]
        }
    ...
    it('Test `fyDaiInForVYDaiOut` function', async () => {
      var values = [
        ['0x0', '0x0', '0x0', '0x0', '0x0', '0x0', true],
        ['0x0', '0x0', '0x1', '0x0', '0x0', '0x0', false],
      ...
      for (var i = 0; i < values.length; i++) {
        ...
        var result
        try {
          result = await yieldMath.fyDaiInForVYDaiOut(daiReserves, fyDaiReserves, daiAmount, timeTillMaturity, k, g, ONE)
        } catch (e) {
          result = [false, undefined]
        }
    ...
    it('Test `vyDaiInForFYDaiOut` function', async () => {
      var values = [
        ['0x0', '0x0', '0x0', '0x0', '0x0', '0x0', true],
        ['0x0', '0x0', '0x1', '0x0', '0x0', '0x0', false],
        // ['0x0', '0x0', '0x0', '0x1', '0xFFFFFFFFFFFFFFFF', '0x10000000000000000', true, 0.0], // Testing too far from reality
      ...
      for (var i = 0; i < values.length; i++) {
        ...
        var result
        try {
          result = await yieldMath.vyDaiInForFYDaiOut(daiReserves, fyDaiReserves, fyDaiAmount, timeTillMaturity, k, g, ONE)
        } catch (e) {
          result = [false, undefined]
        }
    ...
    it('Test rounding induced underflow', async () => {
      ...
      await expectRevert(
        yieldMath.fyDaiInForVYDaiOut(daiReserves, fyDaiReserves, daiAmount, timeTillMaturity, k, g, ONE),
        'VariableYieldMath: Rounding induced error'
      )
      await expectRevert(
        yieldMath.vyDaiInForFYDaiOut(daiReserves, fyDaiReserves, daiAmount, timeTillMaturity, k, g, ONE),
        'VariableYieldMath: Rounding induced error'
      )
    })
  })
